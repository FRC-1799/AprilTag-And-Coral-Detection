...
# Paths
ONNX_MODEL = './BestModel.onnx'
RKNN_MODEL = './Test-640-640-yolov8n.rknn' # TODO: Change this later to be the model name
DATASET_PATH = './dataset.txt'

# Initialize RKNN object
rknn = RKNN(verbose=True)

# Configuration for RK3588. This is the main chip used with PhotonVision, which is used in most Orange Pi's (citation needed)
rknn.config(
