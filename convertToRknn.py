## This was found on the discord server, so it should be the best. Located here https://github.com/boomermath/photonvision_rknn_fork/blob/main/scripts/rknn-convert-tool/create_onnx.py
import argparse
import os
import random
import sys
    ...
    with open(txt_file, "r") as f:
        for line in f:
            ...
            if path and path.lower().endswith(image_extensions):
                ...
                if os.path.exists(abs_path):  # Only add if the file exists
