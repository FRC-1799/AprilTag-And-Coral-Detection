...
# Path to model and video
RKNN_MODEL_PATH = 'Models/algaeAndCoralv8-640-640-yolov8s.rknn'
...
print("[INFO] Init runtime environment...")
...
def filter_boxes(boxes, box_confidences, box_class_probs):
    ...
    _box_pos = np.where(box_confidences >= 0.3)
    ...
    _class_pos = np.where(class_max_score >= 0.3)
...
while cap.isOpened():
    ...
    cv2.imshow('RKNN Object Detection', frame)
