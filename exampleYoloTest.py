...
model = YOLO("/home/lidar/Documents/github/AprilTag-And-Coral-Detection/Models/algaeAndCoralv8-640-640-yolov8s.rknn", task="detect")
# model.load_rknn("Models/algaeAndCoralv8-640-640-yolov8s.rknn")
# ret = model.init_runtime(target="rk3588")
